...
@section('contenu')
    <div class="container-register">
        <a href="{{URL::to('/')}}" class="bouton-retour-register">
            <button><i class="fa-solid fa-circle-chevron-left"></i>
                Retour
            </button>
        </a>
        <div class="container-register-logo">
            ...
            <button name="logo">
                <a href="/">
                    <img src="images/logo-header-noir.svg" alt="" class="registrer-img">
                </a>
            </button>
            ...
            <form method="POST" action="{{ route('register') }}" class="container-register-form">
                ...
                <div class="container-register-firstname">
                    ...
                    <br>
                    <x-input id="firstname" class="register-firstname-input" type="text" name="firstname" 
                ...
                <div class="container-register-mdp">
                    ...
                    <br>
                    <x-input id="password" class="register-mdp-input" type="password" name="password" required autocomplete="new-password" />
                </div>
                <!-- Confirm Password -->
